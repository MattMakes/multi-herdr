...
These repo-owned bundles are curated adaptations of the local public-skills collection, upstream [MattMakes/skill-marketplace](https://github.com/MattMakes/skill-marketplace) at revision `d47670328c59a3311a9b4149bc5f8f33f0a92754`. They are deliberately maintained copies, not links to a developer machine and not byte-for-byte upstream mirrors. [provenance.json](provenance.json) records the exact source path and SHA-256 of each original SKILL.md.
